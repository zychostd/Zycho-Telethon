...
from Zycho import S_PACK_NAME as custompack
from Zycho import bot
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"(?:tikel|kang)\s?(.)?"))
async def kang(args):
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"stickerinfo$"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"delsticker ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"editsticker ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"getsticker$"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"stickers ?([\s\S]*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"itos$"))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"get$"))
async def _(event):
    rep_msg = await event.get_reply_message()
