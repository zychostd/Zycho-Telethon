...
from Zycho import CMD_HELP, LOGS, TEMP_DOWNLOAD_DIRECTORY, bot
from Zycho.events import Zycho_cmd
from Zycho.utils import humanbytes, progress, run_cmd
from Zycho.utils.FastTelethon import download_file, upload_file


@bot.on(Zycho_cmd(pattern=r"download(?: |$)(.*)", outgoing=True))
...
@bot.on(Zycho_cmd(pattern=r"upload (.*)", outgoing=True))
