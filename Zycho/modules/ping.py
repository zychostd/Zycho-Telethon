...
from Zycho import CMD_HELP, StartTime, bot
from Zycho import ALIVE_NAME
from Zycho.events import register
from Zycho.utils import edit_or_reply, humanbytes, Zycho_cmd

absen = [
    "**Hadir bang...**\n**Zycho USERBOT NI BOSS**😆",
    "**Hadir kak...**\n**Zycho USERBOT NI BOSS** 😉",
    "**Hadir dong...**\n**Zycho USERBOT NI BOSS** 😁",
    "**Hadir ganteng...**\n**Zycho USERBOT NI BOSS** 🥵",
    "**Hadir bro...**\n**Zycho USERBOT NI BOSS** 😎",
