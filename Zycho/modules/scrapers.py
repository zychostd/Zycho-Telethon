...
from Zycho import BOTLOG, BOTLOG_CHATID
...
from Zycho.modules.upload_download import get_video_thumb
from Zycho.utils import (
    chrome,
    edit_delete,
    edit_or_reply,
...
from Zycho.utils.FastTelethon import upload_file
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"img (.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"currency ([\d\.]+) ([a-zA-Z]+) ([a-zA-Z]+)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"google ([\s\S]*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"wiki (.*)"))
async def wiki(wiki_q):
    ...
    if len(result) >= 4096:
        ...
        await wiki_q.client.send_file(
            wiki_q.chat_id,
            "output.txt",
            thumb="Zycho/resources/logo.jpg",
            reply_to=wiki_q.id,
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"ud (.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"tts(?: |$)([\s\S]*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"tr(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(Zycho_cmd(pattern=r"lang (tr|tts) (.*)", outgoing=True))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"yt (\d*) *(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"yt(audio|video( \d{0,4})?) (.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"rbg(?: |$)(.*)"))
async def kbg(remob):
...
@bot.on(Zycho_cmd(pattern=r"ocr (.*)", outgoing=True))
async def ocr(event):
...
@bot.on(Zycho_cmd(pattern=r"decode$", outgoing=True))
...
@bot.on(Zycho_cmd(pattern=r"barcode(?: |$)([\s\S]*)", outgoing=True))
async def bq(event):
...
@bot.on(Zycho_cmd(pattern=r"makeqr(?: |$)([\s\S]*)", outgoing=True))
...
@bot.on(Zycho_cmd(pattern=r"ss (.*)", outgoing=True))
