...
from Zycho import ALIVE_EMOJI, ALIVE_LOGO, ALIVE_TEKS_CUSTOM, BOT_VER, CHANNEL
from Zycho import CMD_HANDLER as cmd
from Zycho import CMD_HELP, GROUP, StartTime, bot
from Zycho.utils import bash, edit_or_reply, Zycho_cmd
...
async def amireallyalive(alive):
    ...
    output = (
        f"**[Zycho USERBOT](https://github.com/zychostd/Zycho-Userbot)** by **[LORD Zycho](https://t.me/UnrealZlda)**\n\n"
