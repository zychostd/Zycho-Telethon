...
from Zycho import CMD_HELP, COUNTRY, TZ_NUMBER, bot
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"time(?: |$)(.*)(?<![0-9])(?: |$)([0-9]+)?"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"date(?: |$)(.*)(?<![0-9])(?: |$)([0-9]+)?"))
