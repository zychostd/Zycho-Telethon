...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"reserved$"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"name"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"setpfp$"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"setbio (.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"username (.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"count$"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(Zycho_cmd(pattern=r"info(?: |$)(.*)", outgoing=True))
async def who(event):
