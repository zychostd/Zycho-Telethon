...
import Zycho.modules.sql_helper.blacklist_sql as sql
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"addbl(?: |$)(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"listbl(?: |$)(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"rmbl(?: |$)(.*)"))
