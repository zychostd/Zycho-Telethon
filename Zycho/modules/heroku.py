...
from Zycho import CMD_HELP, HEROKU_API_KEY, HEROKU_APP_NAME, bot
from Zycho.events import Zycho_cmd
from Zycho.modules.sql_helper.globals import addgvar, delgvar, gvarstatus
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"(get|del) var(?: |$)(\w*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"set var (\w*) ([\s\S]*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"(usage|kuota)(?: |$)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"dyno(?: |$)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"logs"))
async def _(dyno):
    if app is None:
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"getdb ?(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"setdb ?(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"deldb ?(.*)"))
...
CMD_HELP.update(
    {
        ...
        \n  •  **Function : **Tambahkan Variabel Baru Atau Memperbarui Variabel Setelah Menyetel Variabel Zycho USERBOT Akan Di Restart.\
