...
from Zycho import CMD_HELP, TEMP_DOWNLOAD_DIRECTORY, ZIP_DOWNLOAD_DIRECTORY, bot
from Zycho.events import Zycho_cmd
from Zycho.utils import progress
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"compress(?: |$)(.*)"))
async def _(event):
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"addzip(?: |$)(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"upzip(?: |$)(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"rmzip(?: |$)(.*)"))
