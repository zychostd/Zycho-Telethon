...
from Zycho import BOT_USERNAME, BOTLOG, BOTLOG_CHATID
from Zycho import CMD_HANDLER as cmd
from Zycho import CMD_HELP, bot, tgbot, user
from Zycho.modules.sql_helper.bot_blacklists import (
    add_user_to_bl,
    check_is_black_list,
    get_all_bl_users,
    rem_user_from_bl,
)
from Zycho.modules.sql_helper.bot_pms_sql import get_user_id
from Zycho.modules.sql_helper.bot_starters import (
    del_starter_from_db,
    get_all_starters,
)
...
@Zycho_cmd(pattern="(set|reset) pmbot(?: |$)(\\w*)")
