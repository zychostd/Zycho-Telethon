...
from Zycho import ALIVE_NAME, DEVS, bot
from Zycho.events import Zycho_cmd, register
from Zycho.utils import get_user_from_event
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"gband(?: |$)(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"ungband(?: |$)(.*)"))
