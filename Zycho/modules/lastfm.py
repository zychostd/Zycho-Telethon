...
from Zycho import BIO_PREFIX, BOTLOG, BOTLOG_CHATID
from Zycho import CMD_HANDLER as cmd
from Zycho import CMD_HELP, DEFAULT_BIO, LASTFM_USERNAME, bot, lastfm
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"lastfm$"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"lastbio (on|off)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"lastlog (on|off)"))
