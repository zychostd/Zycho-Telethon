...
from Zycho import CMD_HELP, DEVS
from Zycho.events import register
...
@Zycho_cmd(pattern="promote(?:\s|$)([\s\S]*)")
...
@Zycho_cmd(pattern="demote(?:\s|$)([\s\S]*)")
...
@Zycho_cmd(pattern="mute(?: |$)(.*)")
@register(incoming=True, from_users=DEVS, pattern=r"^\.cmute(?: |$)(.*)")
async def spider(spdr):
    try:
        from Zycho.modules.sql_helper.spam_mute_sql import mute
...
async def unmoot(unmot):
    ...
    try:
        from Zycho.modules.sql_helper.spam_mute_sql import unmute
    except AttributeError:
...
async def muter(moot):
    try:
        from Zycho.modules.sql_helper.gmute_sql import is_gmuted
        from Zycho.modules.sql_helper.spam_mute_sql import is_muted
    except AttributeError:
        return
...
async def ungmoot(un_gmute):
    ...
    try:
        from Zycho.modules.sql_helper.gmute_sql import ungmute
    except AttributeError:
...
async def gspider(gspdr):
    ...
    try:
        from Zycho.modules.sql_helper.gmute_sql import gmute
    except AttributeError:
