...
from Zycho.utils import chrome, human_to_bytes, humanbytes, md5, time_formatter
...
@bot.on(Zycho_cmd(outgoing=True, pattern="magisk$"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern="pixeldl(?: |$)(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
