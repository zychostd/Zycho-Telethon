...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"anilist ?(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"anime ?(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"manga ?(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern="a(kaizoku|kayo) ?(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern=r"char ?(.*)"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern="upcoming$"))
...
@bot.on(Zycho_cmd(outgoing=True, pattern="whatanime$"))
