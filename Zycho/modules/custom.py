...
from Zycho.modules.sql_helper import snips_sql as sql
from Zycho.utils import edit_delete, edit_or_reply, Zycho_cmd, reply_id


@Zycho_cmd(pattern=r"\#(\S+)")
...
@Zycho_cmd(pattern="custom(?:\\s|$)([\\s\\S]*)")
...
@Zycho_cmd(pattern="delcustom(?:\\s|$)([\\s\\S]*)")
async def _(event):
