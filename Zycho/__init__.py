...
# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "Zycho")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "github.com/zychostd/Zycho-Userbot")
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**Zycho USERBOT v{BOT_VER} is back up and running!**\n\n"
...
try:
    from Zycho.modules.sql_helper.globals import delgvar, gvarstatus
...
with bot:
    try:
        from Zycho.modules.sql_helper.bot_blacklists import check_is_black_list
        from Zycho.modules.sql_helper.bot_pms_sql import add_user_to_db, get_user_id
        from Zycho.utils import reply_id
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@ZeldaProjects"):
                ...
                result = builder.photo(
                    file=logoman,
                    link_preview=False,
                    text=f"**• Zycho USERBOT Inline Menu •**\n\n• **Owner** [{user.first_name}](tg://user?id={user.id})\n• **Jumlah** `{len(dugmeler)}` Modules",
                    buttons=buttons,
                )
            elif query.startswith("repo"):
                result = builder.article(
                    title="Repository",
                    description="Repository Zycho USERBOT",
                    url="https://t.me/ZeldaProjects",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text="**Zycho USERBOT**\n• **Owner Repo :** [Lord Zycho](https://t.me/UnrealZlda)\n• **Support :** @ZeldaProjects\n• **Repository :** [Zycho USERBOT](https://github.com/zychostd/Zycho-Userbot)",
                    buttons=[
                        [
                            custom.Button.url("GROUP CHAT", "https://t.me/HCMutualism"),
                            custom.Button.url(
                                "REPO", "https://github.com/zychostd/Zycho-Userbot"
                            ),
                        ],
                    ],
                    link_preview=False,
                ...
                result = builder.article(
                    title="• Zycho USERBOT •",
                    description="Zycho USERBOT | Telethon",
                    url="https://t.me/ZeldaProjects",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text=f"**Zycho USERBOT**\n• **UserMode:** [{user.first_name}](tg://user?id={user.id})\n• **Assistant:** {tgbotusername}\n**Support:** @ZeldaProjects",
                    buttons=[
                        [
                            custom.Button.url("GROUP CHAT", "https://t.me/HCMutualism"),
                            custom.Button.url(
