...
from Zycho import CMD_HANDLER, CMD_LIST, bot


def Zycho_cmd(pattern=None, command=None, **args):
        ...
        async def wrapper(check):
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    text = "**Zycho USERBOT ERROR REPORT**\n\n"
                    ...
                    ftext += "\ncukup forward saja pesan ini ke @UnrealZycho"
                    ftext += "\n================================\n\n"
